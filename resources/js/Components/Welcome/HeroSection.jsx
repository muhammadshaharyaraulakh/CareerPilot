                    ...
                    >
                        <div className="flex flex-col gap-3 sm:gap-4">
                            <motion.h1
                                ...
                                className="m-0 text-[28px] sm:text-[40px] lg:text-[56px] font-medium leading-[1.2] lg:leading-[64px] tracking-tight text-gray-900"
                            >
                                Find a job that suits your interest and skills.
                            </motion.h1>
                            <motion.p
                                variants={itemVariants}
                                className="m-0 max-w-[536px] text-xs sm:text-base lg:text-lg leading-6 sm:leading-7 text-[#5E6670]"
                            >
                        ...
                        <motion.form
                            variants={itemVariants}
                            className="flex flex-col gap-3 sm:gap-4 max-w-[670px] w-full"
                        ...
                        >
                            ...
                            {/* Suggestion tags */}
                            <motion.div variants={itemVariants} className="flex flex-wrap items-center gap-1.5 text-xs sm:text-sm pt-1">
