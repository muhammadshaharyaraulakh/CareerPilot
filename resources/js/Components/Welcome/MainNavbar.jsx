                                ...
                                >
                                    <div className="flex items-center gap-3 px-1 py-2">
                                        ...
                                        <div className="flex flex-col overflow-hidden">
                                            <span className="text-sm font-semibold text-[#18191C] truncate">{currentUser.name}</span>
                                    ...
                                    <Link
                                        href={route(getDashboardRoute(currentUser.role))}
                                        onClick={() => setIsMobileMenuOpen(false)}
                                        className="w-full h-11 bg-white border border-[#CEE0F5] text-[#0A65CC] font-medium flex items-center justify-center gap-2 rounded-md hover:bg-[#E7F0FA] transition-colors text-sm"
                                    >
                                    ...
                                    <Link
                                        ...
                                        as="button"
                                        onClick={() => setIsMobileMenuOpen(false)}
                                        className="w-full h-11 bg-red-50 border border-red-200 text-red-600 font-medium flex items-center justify-center gap-2 rounded-md hover:bg-red-100 transition-colors text-sm cursor-pointer"
                                    >
