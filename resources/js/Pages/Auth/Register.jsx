...
export default function Register() {
    const [accountType, setAccountType] = useState('candidate'); // 'candidate' | 'company'
                    ...
                    <div className="lg:col-span-6 xl:col-span-6 w-full max-w-[480px] mx-auto lg:mx-0">
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-6">
                            ...
                            >
                                <img 
                                    ...
                                    alt="Employer Icon" 
                                    className={`w-5 h-5 shrink-0 transition-all ${
                                        accountType === 'company' ? 'brightness-0 invert' : 'opacity-75'
                                    }`} 
                                />
                                <span>Employers</span>
                            </button>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <a
                                ...
                                className="flex items-center justify-center gap-2.5 h-12 px-4 bg-white border border-[#E4E5E8] rounded-none text-xs sm:text-sm font-medium text-[#474C56] hover:bg-gray-50 transition-colors cursor-pointer no-underline"
                            >
