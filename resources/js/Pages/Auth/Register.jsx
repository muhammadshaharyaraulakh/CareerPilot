...
export default function Register() {
    const [accountType, setAccountType] = useState('candidate'); // 'candidate' | 'employer'
    ...
    return (
        <div className="min-h-screen w-full bg-white text-[#18191C] font-sans antialiased flex flex-col justify-center selection:bg-transparent selection:text-[#0A65CC]">
            <Head title="Create Account - Jobpilot" />
            ...
            <main className="w-full max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
                ...
                >
                    ...
                    <div className="lg:col-span-6 xl:col-span-6 w-full max-w-[480px] mx-auto lg:mx-0">
                        ...
                        {/* Candidate / Employer Toggle Buttons */}
                        <div className="grid grid-cols-2 gap-3 mb-6">
                            <button
                                type="button"
                                onClick={() => handleRoleChange('candidate')}
                                className={`flex items-center justify-center gap-2.5 h-12 px-4 rounded-none font-semibold text-xs sm:text-sm transition-all duration-200 cursor-pointer ${
                                    accountType === 'candidate'
                                        ? 'bg-[#002452] text-white shadow-sm'
                                        : 'bg-[#F1F2F4] text-[#5E6670] hover:text-[#18191C]'
                                }`}
                            >
                                <img 
                                    ...
                                    className={`w-5 h-5 shrink-0 transition-all ${
                                        accountType === 'candidate' ? 'brightness-0 invert' : 'opacity-75'
                                    }`} 
                                />
                                <span>Candidate</span>
                            </button>
                            ...
                            >
                                <img 
                                    src="/images/auth/employee.svg" 
                                    alt="Employer Icon" 
                                    className={`w-5 h-5 shrink-0 transition-all ${
                                        accountType === 'employer' ? 'brightness-0 invert' : 'opacity-75'
                                    }`} 
                                />
                                <span>Employers</span>
                            </button>
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div className="flex items-center pt-1">
                                <input
                                    ...
                                    className="w-4 h-4 rounded-none text-[#0A65CC] focus:ring-[#0A65CC] border-gray-300 transition-colors cursor-pointer"
                                />
                        ...
                        <div className="relative flex items-center justify-center my-6">
                            <div className="border-t border-[#E4E5E8] w-full" />
                            <span className="bg-white px-3 text-xs text-[#767E94] font-medium tracking-wider uppercase shrink-0">
                                OR
                            </span>
                            <div className="border-t border-[#E4E5E8] w-full" />
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <button
                                type="button"
                                className="flex items-center justify-center gap-2.5 h-12 px-4 bg-white border border-[#E4E5E8] rounded-none text-xs sm:text-sm font-medium text-[#474C56] hover:bg-gray-50 transition-colors cursor-pointer"
                            >
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2.5 h-12 px-4 bg-white border border-[#E4E5E8] rounded-none text-xs sm:text-sm font-medium text-[#474C56] hover:bg-gray-50 transition-colors cursor-pointer"
                            >
                                <svg className="w-4 h-4 shrink-0 fill-current text-[#18191C]" viewBox="0 0 24 24">
                    ...
                    <div className="hidden lg:flex lg:col-span-6 xl:col-span-6 items-center justify-center">
                        <img
                            ...
                            alt="Jobpilot Registration Illustration"
