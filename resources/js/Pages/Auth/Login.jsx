            ...
            <main className="w-full max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
                ...
                >
                    ...
                    <div className="lg:col-span-6 xl:col-span-6 w-full max-w-[480px] mx-auto lg:mx-0">
                        ...
                        {/* Status Message */}
                        {status && (
                            <div className="mb-4 text-sm font-medium text-emerald-600 bg-emerald-50 p-3 rounded-none border border-emerald-200">
                                {status}
                            </div>
                        )}
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div className="flex items-center justify-between pt-1">
                                <div className="flex items-center">
                                    ...
                                    />
                                    <label htmlFor="remember" className="ml-2.5 text-xs text-[#5E6670] cursor-pointer">
                                        Remember me
                                    </label>
                                </div>
                                ...
                                {canResetPassword && (
                                    <Link
                                        ...
                                        className="text-xs text-[#0A65CC] font-semibold no-underline hover:opacity-90"
                                    >
                                        Forgot password?
                                    </Link>
                                )}
                    ...
                    <div className="hidden lg:flex lg:col-span-6 xl:col-span-6 items-center justify-center">
                        <img
                            ...
                            alt="Jobpilot Login Illustration"
